# Comprehensive fix - replace ALL light backgrounds with dark equivalents
$replacements = @{
    ...
    # Dark mode conditionals that shouldn't be needed anymore
...
Write-Host ""
Write-Host "=== LIGHT BACKGROUND FIX COMPLETE ===" -ForegroundColor Cyan
